...
public:
    ...
    void set_size_in_degrees(double value) {
        size_in_degrees = value;
    }
    double get_size_in_degrees() {
        return size_in_degrees;
    }

    void set_shp_filename(const godot::String& value) {
        shpFilename = value;
    }
    godot::String get_shp_filename() {
        return shpFilename;
    }
    void set_shx_filename(const godot::String& value) {
        shxFilename = value;
    }
    godot::String get_shx_filename() {
        return shxFilename;
    }
    void set_prj_filename(const godot::String& value) {
        prjFilename = value;
    }
    godot::String get_prj_filename() {
        return prjFilename;
    }
