...
OriginBasedGeoMap::OriginBasedGeoMap(const GeoCoords &min_bounds, const GeoCoords &max_bounds):
...
void OriginBasedGeoMap::_bind_methods() {
    ...
    ClassDB::bind_method(D_METHOD("set_geo_origin_latitude_degrees", "degrees"), &OriginBasedGeoMap::set_geo_origin_latitude_degrees);
    ClassDB::bind_method(D_METHOD("get_geo_origin_latitude_degrees"), &OriginBasedGeoMap::get_geo_origin_latitude_degrees);
