...
void Parser::set_shader_nodes_paths(godot::TypedArray<godot::NodePath> nodes_paths) {
...
void Parser::_bind_methods()
{
    ...
    ClassDB::bind_method(D_METHOD("set_shader_nodes_paths", "nodes"), &Parser::set_shader_nodes_paths);
    ClassDB::bind_method(D_METHOD("get_shader_nodes_paths"), &Parser::get_shader_nodes_paths);
    ClassDB::bind_method(D_METHOD("get_shader_nodes"), &Parser::get_shader_nodes);


    ClassDB::bind_method(D_METHOD("clear_nodes", "plsrefactor"), &Parser::clear_nodes);
    ClassDB::bind_method(D_METHOD("get_true"), &Parser::get_true);

    ADD_PROPERTY(PropertyInfo(Variant::BOOL, "enabled"), "set_enabled", "is_enabled");
    //ADD_PROPERTY(PropertyInfo(Variant::OBJECT, "scene_tree", PROPERTY_HINT_T, "SceneTree"), "set_scene_tree", "get_scene_tree");
    ADD_PROPERTY(PropertyInfo(Variant::BOOL, "clear_nodes"), "clear_nodes", "get_true");
    ADD_PROPERTY(PropertyInfo(Variant::ARRAY, "shader_nodes", PROPERTY_HINT_ARRAY_TYPE, "NodePath"), "set_shader_nodes_paths", "get_shader_nodes_paths");
}