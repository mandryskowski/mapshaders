...
class GlobalRequirements : public godot::RefCounted {
 ...
 public:
  ...
  GlobalRequirements(godot::PackedStringArray nodeRequirements,
                     godot::PackedStringArray wayRequirements,
                     godot::PackedStringArray relationRequirements);
  GlobalRequirements(godot::Dictionary nodeRequirements,
                     godot::Dictionary wayRequirements,
                     godot::Dictionary relationRequirements);
 ...
 *
 * This function takes a PackedStringArray as input and converts it into a
 * Dictionary. Each element in the PackedStringArray is added as a key in the
