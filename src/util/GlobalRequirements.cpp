...
GlobalRequirements::GlobalRequirements(PackedStringArray nodeRequirements,
                                       PackedStringArray wayRequirements,
                                       PackedStringArray relationRequirements) {
...
GlobalRequirements::GlobalRequirements(Dictionary nodeRequirements,
                                       Dictionary wayRequirements,
                                       Dictionary relationRequirements) {
