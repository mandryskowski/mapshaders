 ...
 *
 * @brief The GlobalRequirementsBuilder class is responsible for building
 * GlobalRequirements objects.
 *
 * The GlobalRequirementsBuilder class provides a fluent interface for
 * constructing GlobalRequirements objects. It allows you to specify node, way,
 * and relation requirements individually or in bulk, and then build the final
 * GlobalRequirements object using the `build()` method.
 */
/**
 * @brief The GlobalRequirementsBuilder class is responsible for building
 * GlobalRequirements objects.
 *
 * This class provides methods for adding node, way, and relation requirements
 * to the builder, and for building the final GlobalRequirements object.
 */
class GlobalRequirementsBuilder : public godot::RefCounted {
 ...
 public:
   ...
   */
  MAPSHADERS_DLL_SYMBOL godot::Variant withNodeRequirement(
      godot::String one_req) {
    ndr.append(one_req);
    return this;
  }
   ...
   * @return A reference to the builder object.
   */
  MAPSHADERS_DLL_SYMBOL godot::Variant withWayRequirement(
      godot::String one_req) {
    wr.append(one_req);
    return this;
  }
   ...
   * @return A reference to the builder object.
   */
  MAPSHADERS_DLL_SYMBOL godot::Variant withRelationRequirement(
      godot::String one_req) {
    rr.append(one_req);
    return this;
  }
   ...
   * @return A reference to the builder object.
   */
  MAPSHADERS_DLL_SYMBOL godot::Variant withNodeRequirements(
      godot::PackedStringArray req) {
    ndr = req;
    return this;
  }
   ...
   * @return A reference to the builder object.
   */
  MAPSHADERS_DLL_SYMBOL godot::Variant withWayRequirements(
      godot::PackedStringArray req) {
    wr = req;
    return this;
  }
   ...
   * @return A reference to the builder object.
   */
  MAPSHADERS_DLL_SYMBOL godot::Variant withRelationRequirements(
      godot::PackedStringArray req) {
    rr = req;
    return this;
  }
